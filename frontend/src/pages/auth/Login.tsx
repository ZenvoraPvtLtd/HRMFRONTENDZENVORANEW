...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    // Construct the Google OAuth URL using the API base URL
    const googleAuthUrl = `${getApiBaseUrl()}/api/auth/google`;
    // Redirect the browser to initiate the OAuth flow
  ...
  const handleTestLogin = () => {
    formik.setValues({ email: 'test@example.com', password: 'test123', rememberMe: false });
    formik.submitForm();
  };
  // Add Test Login button after Google button
