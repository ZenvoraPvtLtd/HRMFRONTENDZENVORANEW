    ...
    return (
      <div className="p-6 max-w-lg mx-auto mt-10">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black rounded-lg hover:bg-zinc-800 dark:hover:bg-zinc-200 transition cursor-pointer text-sm font-semibold"
        >
